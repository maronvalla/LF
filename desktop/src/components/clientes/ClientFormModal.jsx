                        ...
                        <>
                          <button
                            ...
                            onClick={() => {
                              ...
                              updateDraft({ address: reference, latitude: "", longitude: "" });
                          ...
                          <button
                            ...
                            className="w-full text-left px-3 py-2 hover:bg-blue-900/30 border-t border-zinc-700 flex items-center gap-2"
